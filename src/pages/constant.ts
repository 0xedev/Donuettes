...
export const DonuetteV2Address = "0xa71c182707E59b153E7cE544faCC5d886DdAe3f2";

export const DonuetteV2ABI = [
  {
    type: "constructor",
    inputs: [
      {
        name: "_oldDonuetteAddress",
        type: "address",
        internalType: "address",
      },
  ...
  {
    type: "event",
    name: "DonuetteV2__MerkleRootUpdated",
    inputs: [
      {
        name: "oldRoot",
        type: "bytes32",
  ...
  { type: "error", name: "DonuetteV2__ExceedsAllocation", inputs: [] },
  { type: "error", name: "DonuetteV2__ExceedsMaxSupply", inputs: [] },
  { type: "error", name: "DonuetteV2__InvalidProof", inputs: [] },
] as const;
